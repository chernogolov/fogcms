            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="alert">
                        ...
                        <div class="col-sm-5 col-xs-6">
                            <input type="date" class="form-control" name="filters[{{$name}}][{{$i}}][]" value="{{ $filter[2] }}"  form="editForm">
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 col-xs-8">
                        <input type="date" class="form-control" name="filters[{{$name}}][{{$i}}][]" form="editForm"  value="{{ date('Y-m-d') }}" list="dateList">
                        <datalist id="dateList">
                            <option value="{{ date('Y-m-d', time() + 86400) }}" label="{{__('Tomorrow')}}">
                            <option value="{{ date('Y-m-d') }}" label="{{__('Today')}}">
                            <option value="{{ date('Y-m-d', time() - 86400) }}" label="{{__('Yesterday')}}">
                        </datalist>
                    </div>
                </div>
            </div>
