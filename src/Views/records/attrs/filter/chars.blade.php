            ...
            <div class="modal-body">
                                ...
                                <div class="alert row">
                                    <div class="input-group">
                                        ...
                                        <select name="filters[{{$name}}][{{$i}}][]" class="form-control" form="modalForm">
                                            ...
                                            <option value="LIKE" @if($filter[1] == 'LIKE') selected @endif>Contains</option>
                                        </select>
                                        <input type="text" class="form-control" name="filters[{{$name}}][{{$i}}][]" value="{{ $filter[2] }}"  form="modalForm">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 col-xs-8">
                        <input type="text" class="form-control" name="filters[{{$name}}][{{$i}}][]" form="modalForm">
                    </div>
                </div>
            </div>
