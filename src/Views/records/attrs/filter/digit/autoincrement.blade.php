            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 col-xs-8">
                        <input type="number" class="form-control" name="filters[{{$name}}][{{$i}}][]" form="modalForm" value="">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal" >{{__('Close')}}</button>
                <button type="submit" role="submit" name="filter" data-dismiss="modal" data-destination="records" class="btn btn-primary submit" form="modalForm">{{__('Filter')}}&nbsp;<span class="mdi mdi-filter"></span></button>
            </div>
        </div>
    </div>
</div>
