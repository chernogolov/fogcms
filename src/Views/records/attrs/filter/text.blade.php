            ...
            <div class="modal-body">
                    ...
                    <div class="alert">
                        ...
                        <div class="col-sm-3 col-xs-4">
                            <select name="filters[{{$name}}][{{$i}}][]" class="form-control" form="editForm">
                                ...
                                <option value="LIKE" @if($filter[1] == 'LIKE') selected @endif>{{__('Contains')}}</option>
                            </select>
                        </div>
                        <div class="col-sm-5 col-xs-6">
                            <input type="text" class="form-control" name="filters[{{$name}}][{{$i}}][]" value="{{ $filter[2] }}"  form="editForm">
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 col-xs-8">
                        <input type="text" class="form-control" name="filters[{{$name}}][{{$i}}][]" form="editForm">
                    </div>
                </div>
            </div>
