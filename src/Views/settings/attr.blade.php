<form method="post" class="form-horizontal" id="editForm" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" name="attr[title]" class="form-control" id="inputName" placeholder="заголовок" value="{{ $attr->title }}" form="editForm" autocomplete="off">
        </div>
    </div>
    <div class="form-group row">
        <label for="inputName" class="col-sm-4 text-left">{{__('Slug')}}</label>
        <div class="col-sm-8">
            <input type="text" name="attr[name]" class="form-control" id="inputName" placeholder="имя" value="{{ $attr->name }}" form="editForm" autocomplete="off">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" name="attr[modificator]" class="form-control" id="inputName" placeholder="{{__('Modificator')}}" value="{{ $attr->modificator }}" form="editForm" autocomplete="off">
        </div>
    </div>
    <div class="form-group row">
        <label for="inputName" class="col-sm-4 text-left">{{__('Metadata')}}</label>
        <div class="col-sm-8">
            <input type="text" name="attr[meta]" class="form-control" id="inputName" placeholder="{{__('Metadata')}}" value="{{ $attr->meta }}" form="editForm" autocomplete="off">
        </div>
    </div>
    <hr>
    <div class="form-group row">
