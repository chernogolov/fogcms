							   		...
							   		<div class="col-10 p-0 slidebar-top d-flex flex-column justify-content-between">
										...
										<ul class="list-group">
                                            ...
                                            <div class="logout mt-5">
                                                <a onclick="event.preventDefault(); document.getElementById('logout-form').submit();" href="{{ route('logout') }}" class="d-flex justify-content-between"><span>Выход из системы</span><img src="/vendor/chernogolov/fogcms/public/img/exit_btn_while.png" alt="exit"></a>
