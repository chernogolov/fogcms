    ...
    <div class="col-lg-8">
        ...
        <div class="input-group">
            @if(isset($attr->values) && count($attr->values)>0)
                <select class="sl sl-r form-control" data-id="{{$attr->meta}}" name="attr[{{ $attr->name }}][value]" id="list-{{$attr->meta}}" @if($attr->is_required == 1) required="required" @endif>
            ...
            @else
                <select class="sl sl-r clear form-control" data-id="{{$attr->meta}}" name="attr[{{ $attr->name }}][value]" id="list-{{$attr->meta}}" @if($attr->is_required == 1) required="required" @endif></select>
            @endif
        </div>
