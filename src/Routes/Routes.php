...
//LK
Route::match(['get', 'post'], '/', 'Chernogolov\Fogcms\Controllers\LkController@index')->name('lk')->where('id', '[0-9]+')->middleware('web');
...
//COMMENTS
Route::get('/panel/comments/{rid}', 'Chernogolov\Fogcms\Controllers\CommentsController@getComments')->name('comments')->where('rid', '[0-9]+');
Route::match(['get', 'post'], '/panel/comments/edit/{rid}', 'Chernogolov\Fogcms\Controllers\CommentsController@editComments')->name('editcomments')->where('rid', '[0-9]+');
Route::match(['get', 'post'], '/panel/comments/delete/{rid}', 'Chernogolov\Fogcms\Controllers\CommentsController@deleteComments')->name('deletecomments')->where('rid', '[0-9]+');
//END COMMENTS
...
//???
Route::match(['get', 'post'], '/usearch', 'Chernogolov\Fogcms\Controllers\UsersController@searchUser')->name('usearch');
Route::match(['get', 'post'], '/reg/{id}', 'Chernogolov\Fogcms\Controllers\RecordsController@ajaxReg')->name('reg');
Route::match(['get', 'post'], '/search/{id}', 'SearchController@search')->name('search');
Route::match(['get', 'post'], '/record/{id}/{rid}', 'Chernogolov\Fogcms\Controllers\SearchController@get_record')->name('get_record')->where(['id' => '[0-9]+', 'rid' => '[0-9]+']);
//???
